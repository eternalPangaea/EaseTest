...
public class HostFormController {
	...
	public String doUploadPage (@RequestParam("file")MultipartFile file,@RequestParam("file2")MultipartFile file2,HostForm hostform)throws IOException{
...
//        	   System.out.println(time);
        	   ...
        	   hostform.setHostFormRole("1");
        	   hostform.setBedroomPicture1_1(time);
        	   hostform.setBedroomPicture1_2(time2);
        	   hostformService.create(hostform);
